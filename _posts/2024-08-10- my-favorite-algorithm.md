...
This proof might seem like overkill for such a simple idea but since this post contains my pedagogical opinions, dislpays the process of careful algorithm design and rigorous math, and is not written for a mathematical audience, it's important to be very detailed. For example, for one of the previous paragraphs I could have simply said "Since we have a bipartite graph with equal sized parts $$U$$ and $$W$$, it suffices to show that a matching saturates all of $$U$$", but that's neither instructive nor elucidating for certain audiences. This is a great way to start messing with combinatorial definitions and seeing how much precision needs to be involved.
...
You should be surprised at this claim, and not just in the sense of it not being immediately obvious. There are a few things about this claim that should warrant suspicion. Firstly, it's not clear that $$S^*$$ is even a matching in the first place; for example, why can't two men have the same best valid partner? It also states every execution of the Gale-Shapley algorithm gives the best result possible for the men...that every man is simultaneously happy in that there was no way they could have done any better. Finally, it conclusively states that the order of proposals in the Gale-Shapley algorithm has no effect at all on the outcome. Let's prove it.

**Proof:** Suppose for sake of contradiction that some execution $$R$$ of the Gale Shapley algorithm results in the matching $$S$$ in which a man is not paired with his best valid partner. This must mean that some man is rejected by a valid partner in execution $$R$$, since men start off proposing at the top of their preference lists. Consider the first such moment during execution $$R$$ in which a man $$m$$ is rejected by a valid partner of his $$w$$. Call this moment time $$ \tau $$ (or iteration $$ \tau $$). This is the first time a rejection of a man by a valid partner has occurred in $$R$$, meaning $$w = best(m)$$.

We do not know if the rejection of $$m$$ by $$w$$ in this execution happened because $$w$$ was previously engaged to a man she prefers over $$m$$ or if the engagement of $$m$$ and $$w$$ was broken by a man she prefers to $$m$$, but either way at time $$ \tau $$, $$w$$ forms or continues an engagement with a man $$m'$$ who she prefers to $$m$$.

Because $$w$$ is a valid partner of $$m$$, there exists a stable matching $$S'$$ in which $$(m,w)$$ are married. But what happens to $$m'$$ in this matching? Let's say he ends up paired with a woman $$w' \neq w$$. Then by definition $$w'$$ is a valid partner of $$m'$$. But in the execution $$R$$, time $$ \tau $$ was the first time a man was rejected by a valid partner, and since $$m'$$ became engaged to $$w$$ at latest at this exact moment, we know that $$m'$$ had not been rejected by any valid partner when he became engaged to $$w$$. But this must mean that $$m'$$ prefers $$w$$ to $$w'$$, since again men propose in order of decreasing preference. But we have already seen that $$w$$ prefers $$m'$$ to $$m$$. Thus, the pair $$(m', w)$$ form an instability with respect to $$S'$$ which contradicts the claim that $$S'$$ is stable. This further contradicts our initial assumption of the existence of a stable matching $$S$$ in which a man is not paired with his best valid partner.


$$\tag*{$\blacksquare$}$$

**Proof commentary:** These are some technical comments assuming you have understood the proof already to improve your proof-reading skills and get down to the details of what really happened here. There are two contradictions here, only the latter of which completes our proof. We **assume** the existence of a stable matching $$S$$ in which a man $$m$$ is not paired with his best valid partner $$w$$. We then conclude from this assumption that there exists another stable matching $$S'$$ in which $$(m, w)$$ are a pair. We perform some logic, using our assumption above, to conclude further that $$S'$$ actually cannot be a stable matching, which contradicts the **claim** (not assumption) that $$S'$$ is stable. This in turn leads us to contradict our initial assumption of the existence of stable matching $$S$$ where $$m$$ and $$w = best(m)$$ are not paired, which proves our theorem. Technical, but important to really break down what is an assumption and what is a conclusion drawn from this assumption, especially when multiple contradictions are happening. 
...
Explained in a different way, if two men both really like the same woman, then the woman gets to choose between those two. The guy who ends up getting rejected couldn't have had that woman anyways, in **any** stable matching, so he moves onto the next best woman for him. That means he eventually gets the highest ranking partner that was possible for him to get. Meanwhile, the woman has to settle; she may not be satisfied with the guy she ends up with but she does not have any power to reject him because she got no other proposals. The choice that women seem to have in rejecting partners is an illusion, because the men are who feed them the choices in the first place, and they will always make it so that the choices work best for them. What good is making a choice between two potentially horrible options? The men play greedy opportunist and it works perfectly in this problem setup since they never have to "settle".
