...
The choice that women seem to have in rejecting partners is an illusion, because the men are who feed them the choices in the first place, and they will always make it so that the choices work best for them. What good is making a choice between two potentially horrible options?
